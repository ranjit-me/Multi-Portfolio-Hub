...
const Template = () => {
  ...
  const changeTemplate = async (templateId) => {
    ...
    try {
      ...
      const templateName = template ? template.title : templateId.replace(/-/g, ' ').replace(/\b\w/g, l => l.toUpperCase());
      ...
      notification.textContent = `✅ Template changed to ${templateName}! Redirecting to dashboard...`;
